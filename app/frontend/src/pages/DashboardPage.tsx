      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-6 py-3">
          <nav className="text-sm text-gray-500 dark:text-gray-400">
            <span className="text-blue-600 dark:text-blue-400">WikiDocs</span> &gt; Get started
          </nav>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-shadow">
            ...
            <a href="/spaces" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-medium">
              Explore spaces →
            </a>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Create Content</h3>
            </div>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Start writing documentation, guides, and knowledge base articles for your team.
            </p>
            {(user?.role === 'ADMIN' || user?.role === 'EDITOR') ? (
              <a href="/create" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-medium">
                Create new page →
              </a>
            ) : (
              <span className="text-gray-400 dark:text-gray-500 font-medium">Editor access required</span>
            )}
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Collaborate</h3>
            </div>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Organize</h3>
            </div>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Structure your knowledge with spaces, categories, and intelligent tagging.
            </p>
            <a href="/pages" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-medium">
              View all pages →
            </a>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Search & Discover</h3>
            </div>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
          ...
          {user?.role === 'ADMIN' && (
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-shadow">
              ...
              <a href="/settings" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-medium">
                System settings →
              </a>
            </div>
          )}
              ...
              <div key={index} className="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm text-gray-900 dark:text-white">
                    ...
                    <span className="font-medium text-blue-600 dark:text-blue-400">{activity.page}</span>
                  </p>
